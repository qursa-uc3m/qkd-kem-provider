...
static int oqsx_to_text(BIO *out, const void *key, int selection) {
    ...
    if ((selection & OSSL_KEYMGMT_SELECT_PRIVATE_KEY) != 0) {
        ...
        switch (okey->keytype) {
        case KEY_TYPE_QKD_HYB_KEM: //TODO_QKD: check if specific adaptation is needed
...
MAKE_ENCODER(, qkd_frodo640aes, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_frodo640shake, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_frodo976aes, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_frodo976shake, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_frodo1344aes, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_frodo1344shake, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_kyber512, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_kyber768, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_kyber1024, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_mlkem512, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_mlkem768, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_mlkem1024, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_bikel1, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_bikel3, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_bikel5, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_hqc128, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_hqc192, oqsx, PrivateKeyInfo, pem);
...
MAKE_ENCODER(, qkd_hqc256, oqsx, PrivateKeyInfo, pem);
MAKE_ENCODER(, qkd_hqc256, oqsx, SubjectPublicKeyInfo, der);
